...
export default async function NeedDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="catalog-page need-detail">
      <header className="catalog-header"><Link href="/" className="catalog-brand"><span className="brand-mark">AI</span> <b>AIgora</b></Link><Link href="/needs">← Όλες οι ανάγκες</Link></header>
